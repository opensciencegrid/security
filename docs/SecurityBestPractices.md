...
-   Ensure that the software installation procedures follow all posted OSG security policies and procedures (see the [OSG security pages](index.md) for more details);
